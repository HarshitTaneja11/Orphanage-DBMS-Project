...
ALTER TABLE Donation MODIFY Donor_ID INT NULL;
ALTER TABLE Allocation MODIFY Staff_ID INT NULL;

ALTER TABLE Donation
DROP FOREIGN KEY donation_ibfk_1;
...
DROP FOREIGN KEY allocation_ibfk_1,
DROP FOREIGN KEY allocation_ibfk_2,
DROP FOREIGN KEY allocation_ibfk_3;

ALTER TABLE Allocation
ADD CONSTRAINT fk_allocation_child
...
ADD CONSTRAINT fk_allocation_staff
